...
export const paths = {
  ...
  dashboard: {
    ...
    purchases: {
      ...
      accountsPayable: `${purchases}/accounts-payable`,
    },
    claims: {
      root: claims,
      new: `${claims}/new`,
    ...
    admin: {
      ...
      reportes: {
        ...
        pacientesCronicos: `${admin}/reportes/pacientes-cronicos`,
        comportamientoClientes: `${admin}/reportes/comportamiento-clientes`,
        flujoCaja: `${admin}/reportes/flujo-caja`,
