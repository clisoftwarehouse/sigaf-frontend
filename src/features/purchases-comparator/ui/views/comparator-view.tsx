...
export function ComparatorView() {
  ...
  // Lookups para los dropdowns de filtros. Se cachean 4 min (gen options
  // rara vez cambian). El backend las cachea 5 min server-side.
  ...
  return (
    <Container maxWidth="xl" sx={{ pb: 6 }}>
      <PageHeader
        ...
        subtitle="Mercado externo (iCompras360). Compará precios por principio activo entre droguerías. Datos en Bs."
